...
//    new (containerClientId: string, fieldType: number);
...
class soby_WebGrid {
    ...
    OnCellSelected = null;
    /*********************************************************************************/
    constructor(contentDivSelector:string, title:string, dataService, emptyDataHtml:string, webUrl:string) { 
...
class soby_Carousel{
    constructor(contentDivSelector: string, title: string, dataService, emptyDataHtml: string, webUrl: string, imageFieldName: string, captionFieldName: string, contentFieldName: string, isContentFieldUrl:boolean) {
        this.ContentDivSelector = contentDivSelector;
        this.Title = title;
        this.WebUrl = webUrl;
        this.DataService = dataService;
...
class soby_MetroTilesGrid {
    constructor(contentDivSelector: string, title: string, dataService, emptyDataHtml: string, webUrl: string, imageFieldName: string, captionFieldName: string, urlFieldName: string, openInNewWindowFieldName: string, startColorFieldName: string, endColorFieldName: string, colspanFieldName: string, rowspanFieldName: string) {
        this.ContentDivSelector = contentDivSelector;
        this.Title = title;
        this.WebUrl = webUrl;
        this.DataService = dataService;
...
function soby_Menu(contentDivSelector, webUrl, dataService, displayNameField, idField, parentIdField) {
