...
class soby_WebGrid {
    ...
    constructor(contentDivSelector, title, dataService, emptyDataHtml) {
         ...
         * Item creation event.
         *
         * @event ItemCreated#soby_WebGrid
         * @type {object}
         ...
         *
         * @event OnGridPopulated#soby_WebGrid
         * @type {object}
         */
         ...
         * Row selection event.
         *
         * @event OnRowSelected#soby_WebGrid
         * @type {object}
         */
         ...
         *
         * @event OnCellSelected#soby_WebGrid
         * @type {object}
    ...
    */
    ...
    Activate() {
        ...
        this.HideHeaderRowMenu(null, null);
    }
    /**
    ...
    */
     ...
     */
    AddColumn(fieldName, displayName, showFieldsOn, displayFunction, cellTemplate, sortable, filterable, editable, filterControl) {
     ...
     *
     * @detailGridID Identifier of the detailg grid.
     * @contentDivSelector Selector div of the detail grid.
     * @mainRowId Row identifier of the master grid.
     * @fieldName Name of the field.
     * @value Filter value for the detail grid.
     */
    PopulateDetailGrid(detailGridID, contentDivSelector, mainRowId, fieldName, value) {
    ...
    ClearFiltersOn(fieldName) {
        ...
        this.HideHeaderRowMenu(null, fieldName);
     ...
     * @fieldName Name of the field.
     */
    HideHeaderRowMenu(ev, fieldName) {
     ...
     * @filterable States whether it is filterable or not.
     */
    ShowHeaderRowMenu(ev, fieldName, displayName, sortable, filterable) {
