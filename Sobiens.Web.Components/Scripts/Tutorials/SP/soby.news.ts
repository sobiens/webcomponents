...
function soby_PopulateSPNewsImages(itemID)
{
    soby.SPLibrary.Lists.GetListItemAttachments("News", itemID, function (itemID, attachments)
    {
        ...
        */
        ...
        const staticDataService = new soby_StaticDataService([
            new SobySchemaField("Id", SobyFieldTypes.Text, null),
        ...
        const carousel = new soby_Carousel("#soby_newsImageDiv_" + itemID, "Carousel", staticDataService, "There is no record found.", "Image", "Title", "Body", false);
