...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>This example demonstrates how to use Soby Item Selection with Soby Data Grid as the advanced search control. <br />
        ...
        <div class="article" style="float: left;width: 74%;">
            ...
            <script src="/Scripts/Tutorials/WebAPI/TreeView/treeview.js"></script>
            <div class="row">
                <div class="col-md-8"><div id='soby_PremisesDiv'></div></div>
                <div class="col-md-4"><div id='soby_ResultDiv'></div></div>
            </div>
        <a href="javascript:void(0)" onclick="soby_ShowHideViewSource()">
            <img src="/Images/viewsource.png" border="0" width="20px" /> View source
        </a>
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/TreeView/treeview.js" style="display:none;background-color:ivory">
