<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ValueDateValidation.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyValidator.ValueDateValidation" Title="Soby Validator" %>
        ...
        <div class="row">
            <div class="col-md-12" style="height: 400px;overflow: auto;">
                <div id="ValidationPanel_Presence" style="height: 400px">
                    <h4>Date Validator</h4>
                    <p>
                        This example demonstrates how to use date validator in the Soby Validator.
                        <br />
                        ...
                        <pre class="js">
 sobyValidate.GetValidator(soby_ValidatorTypes.Email).Validate("test@sobiens.com");<br /> Output:true<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Email).Validate("test.sobiens.com");<br /> Output:false<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Email).Validate("test.sobiens.com");<br /> Output:false
                        </pre>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/Validator/valuedatevalidation.js" style="display: none; background-color: ivory">
...
<span class="tag_start">&lt;script</span> <span class="attr_name">src</span>=<span class="attr_value">"/Scripts/Tutorials/Validator/valuedatevalidation.js"</span> <span class="tag_start">&gt;&lt;/script&gt;</span>
