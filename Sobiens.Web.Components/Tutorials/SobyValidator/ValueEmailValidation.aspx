<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ValueEmailValidation.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyValidator.ValueEmailValidation" Title="Soby Validator" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
 ...
 sobyValidate.GetValidator(soby_ValidatorTypes.Email).Validate("test.sobiens.com");<br /> Output:false
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/Validator/valueemailvalidation.js" style="display: none; background-color: ivory">
...
<span class="tag_start">&lt;script</span> <span class="attr_name">src</span>=<span class="attr_value">"/Scripts/Tutorials/Validator/valueemailvalidation.js"</span> <span class="tag_start">&gt;&lt;/script&gt;</span>
