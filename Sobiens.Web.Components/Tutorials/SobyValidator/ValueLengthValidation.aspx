<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ValueLengthValidation.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyValidator.ValueLengthValidation" Title="Soby Validator" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
 ...
 exclusionValidator.Validate("istanbul");<br /> Output:true<br />
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/Validator/valuelengthvalidation.js" style="display: none; background-color: ivory">
...
<span class="tag_start">&lt;script</span> <span class="attr_name">src</span>=<span class="attr_value">"/Scripts/Tutorials/Validator/valuelengthvalidation.js"</span> <span class="tag_start">&gt;&lt;/script&gt;</span>
