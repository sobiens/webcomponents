<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ValuePresenceValidation.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyValidator.ValuePresenceValidation" Title="Soby Validator" %>
    ...
    <section class="featured">
        <div class="content-wrapper">
            <hgroup class="title">
                <h1><%: Title %></h1>
                <br />
                <h2>Presence Validator Example</h2>
            </hgroup>
        </div>
    </section>
</asp:Content>
            ...
            <div class="col-md-12" style="height: 400px;overflow: auto;">
                <div id="ValidationPanel_Presence" style="height: 400px">
                    ...
                    <p>
                        ...
                        <pre class="js">
 sobyValidate.GetValidator(soby_ValidatorTypes.Presence).Validate(null);<br /> Output:false<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Presence)Validate(undefined);<br /> Output:false<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Presence).Validate("");<br /> Output:false<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Presence).Validate("test");<br /> Output:true<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Presence).Validate("32");<br /> Output:true<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Presence).Validate("! */+");<br /> Output:true
                        </pre>
                    </p>
                </div>
            </div>
