<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ValueNumericValidation.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyValidator.ValueNumericValidation" Title="Soby Validator" %>
            ...
            <div class="col-md-12" style="height: 400px;overflow: auto;">
                <div id="ValidationPanel_Presence" style="height: 400px">
                    ...
                    <p>
                        ...
                        <pre class="js">
 sobyValidate.GetValidator(soby_ValidatorTypes.Numeric).Validate("32");<br /> Output:true<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Numeric).Validate("t21");<br /> Output:false<br />
 sobyValidate.GetValidator(soby_ValidatorTypes.Numeric).Validate("test");<br /> Output:false
                        </pre>
                        </p>
                </div>
            </div>
