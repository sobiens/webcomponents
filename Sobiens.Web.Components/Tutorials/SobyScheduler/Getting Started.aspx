...
<br />
    <div>
            ...
            <script src="/Scripts/Tutorials/StaticData/Scheduler/scheduler.js"></script>
            <div id='soby_SchedulerDiv'></div>
            <div id='soby_SchedulerChangesDiv'></div>
        <input type="button" value="Get Changes" onclick="DisplayScheduleChanges()" />
        <a href="javascript:void(0)" onclick="soby_ShowHideViewSource()">
            <img src="/Images/viewsource.png" border="0" width="20px" /> View source
        </a>
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/StaticData/Scheduler/scheduler.js" style="display:none;background-color:ivory">
