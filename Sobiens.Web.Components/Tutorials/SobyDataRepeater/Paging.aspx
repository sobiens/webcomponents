<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Paging.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyDataRepeater.Paging" Title="DataRepeater" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="article col-md-9">
            ...
            <script src="/Scripts/Tutorials/WebAPI/DataRepeater/paging.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/DataRepeater/paging.js" style="display:none;background-color:ivory">
