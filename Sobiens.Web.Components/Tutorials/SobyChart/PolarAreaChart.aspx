...
<%--    <p>This example demonstrates how to use filtering in the Soby Data Grid. <br />
    ...
    <p>Filter by 
        ...
        <div class="article" style="float: left;width: 74%;">
            ...
            <script src="/Scripts/Tutorials/WebAPI/Chart/polarareachart.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/Chart/polarareachart.js" style="display:none;background-color:ivory">
