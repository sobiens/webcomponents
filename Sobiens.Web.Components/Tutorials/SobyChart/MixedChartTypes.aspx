<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MixedChartTypes.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyChart.MixedChartTypes" Title="Bar Chart" %>
...
&lt;body&gt;
    &lt;div id="soby_ChartDiv" data-width="600" data-height="300"&gt;
        &lt;div class='dataset' data-type="ColumnChart" data-title="Chart1" data-data="1;#10;#70;#35;#50;#100"&gt;&lt;/div&gt;
        &lt;div class='dataset' data-type="ColumnChart" data-title="Chart2" data-data="12;#15;#17;#71;#22;#50"&gt;&lt;/div&gt;
...
&lt;body&gt;
    ...
    &lt;soby-chart id="soby_ChartDiv" width="600" height="300"&gt;
        &lt;dataset type="ColumnChart" title="Chart1" data="1;#10;#70;#35;#50;#100"&gt;&lt;/dataset&gt;
        &lt;dataset type="ColumnChart" title="Chart2" data="12;#15;#17;#71;#22;#50"&gt;&lt;/dataset&gt;
          ...
          (function (angular) {
              ...
              angular.module('sobyChartApp', []).controller('MainCtrl', function MainCtrl($scope) {
                  this.chart = {
                      ...
                      width: 400,
                      height: 200,
                      datasets: [{ type: "ColumnChart", title: "Chart1", data: "1;#10;#70;#35;#50;#100" }
                                 , { type: "ColumnChart", title: "Chart2", data: "12;#15;#17;#71;#22;#50" }
