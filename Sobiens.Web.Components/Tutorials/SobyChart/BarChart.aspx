<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="BarChart.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyChart.BarChart" Title="Bar Chart" %>
...
&lt;head&gt;
    &lt;title&gt;Soby Bar Chart Demo&lt;/title&gt;
...
&lt;/html&gt;</div>
    ...
    dataSet1.Type=SobyChartTypes.BarChart;
    dataSet1.Data = [1, 10, 70, 35, 50, 100];

    var dataSet2 = new SobyChartDataset();
    dataSet2.Title = "Chart2";
    dataSet2.Type=SobyChartTypes.BarChart;
    dataSet2.Data = [12, 15, 17, 71, 22, 50];

    var dataSet3 = new SobyChartDataset();
    dataSet3.Title = "Chart3";
    dataSet3.Type=SobyChartTypes.BarChart;
    dataSet3.Data = [21, 51, 31, 6, 62, 24];

    var barChart = new SobyChart("#soby_ChartDiv", "Bar Chart", [dataSet1, dataSet2, dataSet3], "There is no record found.", ["January", "February", "March", "April", "May", "June"]);
    barChart.Width = 600;
    barChart.Height = 300;
    barChart.HorizontalAxisSettings.Title = "JOJO";
    barChart.VerticalAxisSettings.Title = "JOJOX";
    barChart.Legend.Position = SobyChartElementPosition.Top;
    barChart.Legend.VerticalAligment = SobyChartVerticalAligment.Bottom;
    barChart.Legend.HorizontalAligment = SobyChartHorizontalAligment.Right;
    barChart.Initialize();
                        </div>
...
&lt;body&gt;
    &lt;div id="soby_ChartDiv" data-width="600" data-height="300"&gt;
        &lt;div class='dataset' data-type="BarChart" data-title="Chart1" data-data="1;#10;#70;#35;#50;#100"&gt;&lt;/div&gt;
        &lt;div class='dataset' data-type="BarChart" data-title="Chart2" data-data="12;#15;#17;#71;#22;#50"&gt;&lt;/div&gt;
        &lt;div class='dataset' data-type="BarChart" data-title="Chart3" data-data="21;#51;#31;#6;#62;#24"&gt;&lt;/div&gt;
...
&lt;body&gt;
    ...
    &lt;soby-chart id="soby_ChartDiv" width="600" height="300"&gt;
        &lt;dataset type="BarChart" title="Chart1" data="1;#10;#70;#35;#50;#100"&gt;&lt;/dataset&gt;
        &lt;dataset type="BarChart" title="Chart2" data="12;#15;#17;#71;#22;#50"&gt;&lt;/dataset&gt;
        &lt;dataset type="BarChart" title="Chart3" data="21;#51;#31;#6;#62;#24"&gt;&lt;/dataset&gt;
          ...
          (function (angular) {
              ...
              angular.module('sobyChartApp', []).controller('MainCtrl', function MainCtrl($scope) {
                  this.chart = {
                      ...
                      width: 400,
                      height: 200,
                      datasets: [{ type: "BarChart", title: "Chart1", data: "1;#10;#70;#35;#50;#100" }
                                 , { type: "BarChart", title: "Chart2", data: "12;#15;#17;#71;#22;#50" }
                                 , { type: "BarChart", title: "Chart3", data: "21;#51;#31;#6;#62;#24" }],
