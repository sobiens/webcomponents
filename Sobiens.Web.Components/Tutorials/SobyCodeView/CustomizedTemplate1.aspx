...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <script src="/Scripts/Tutorials/CodeView/customizedtemplate1.js"></script>
    <h3>Example</h3>
...
document.write(fruits);&lt;/script&gt;</div><div class="codedescription">This example displays all array values</div><div class="resultdescription"></div></div>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/Codeview/customizedtemplate1.js" style="display:none;background-color:ivory">
