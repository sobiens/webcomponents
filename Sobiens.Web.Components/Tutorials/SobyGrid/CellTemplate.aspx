...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>This example demonstrates how to use cell template in the Soby Data Grid. <br />
        ...
        <pre class="js">var cellTemplate1 = { TemplateType: "CellContent", PopupLinkText: "More info", Template: "&lt;div&gt;&lt;div style='background-color: blue;color: white;padding: 5px;float: left;width:250px'&gt;&lt;strong&gt;Author:&lt;/strong&gt; #{Author.Name}&lt;br&gt;&lt;strong&gt;Genre:&lt;/strong&gt; #{Genre}&lt;br&gt; &lt;strong&gt;Year:&lt;/strong&gt; #{Year}&lt;br&gt;&lt;strong&gt;Price:&lt;/strong&gt; $#{Price}&lt;/div&gt;&lt;/&lt;div&gt;" };
bookGrid.AddColumn("Year", "Description", SobyShowFieldsOn.All, null, cellTemplate1, true, true, true, null, null, null);
        ...
        <pre class="js">var cellTemplate2 = { TemplateType: "PopupContent", PopupLinkText: "More info", Template: "&lt;div&gt;&lt;div style='background-color: blue;color: white;padding: 5px;float: left;width:250px'&gt;&lt;strong&gt;Author:&lt;/strong&gt; #{Author.Name}&lt;br&gt;&lt;strong&gt;Genre:&lt;/strong&gt; #{Genre}&lt;br&gt; &lt;strong&gt;Year:&lt;/strong&gt; #{Year}&lt;br&gt;&lt;strong&gt;Price:&lt;/strong&gt; $#{Price}&lt;/div&gt;&lt;/div&gt;" };
