...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="article col-md-9">
            ...
            <script src="/Scripts/Tutorials/WebAPI/Grid/responsivedesign.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/Grid/responsivedesign.js" style="display:none;background-color:ivory">
