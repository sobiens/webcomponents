<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MultipleSelection.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyGrid.MultipleSelection" Title="DataGrid - Selection Example" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <script language="javascript">
        ...
        <p>
        "AllowMultipleSelections" property is used to state whether user can select multiple or single row. "true" will allow user to select multiple rows.
        </p>
        <pre class="js">bookGrid.AllowMultipleSelections = true; </pre>
...
&lt;/html&gt;</div>
    ...
    bookGrid.AllowMultipleSelections = true;
