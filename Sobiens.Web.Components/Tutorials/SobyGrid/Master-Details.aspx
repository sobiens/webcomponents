<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Master-Details.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyGrid.MasterDetails" Title="Grid" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="article col-md-9">
            ...
            <script src="/Scripts/Tutorials/WebAPI/Grid/masterdetails.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/Grid/masterdetails.js" style="display:none;background-color:ivory">
...
<span class="tag_start">&lt;div</span> <span class="attr_name">id</span>=<span class="attr_value">'soby_AuthorsDiv'</span> <span class="tag_start">&gt;&lt;/div&gt;</span>
