...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>        Below functionality uses "GroupBy" method which takes two parameters. First one is the name of the field. Second one is a boolean value to state whether it should be sorted as ascending or descending. This method triggers the data population.
    ...
    <p>Group by 
        ...
        <input type="button" value="Apply" onclick="sobyApplyGrouping()" />
    </p>
    ...
    <div class="article" style="float: left;width: 74%;">
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/Grid/grouping.js" style="display:none;background-color:ivory">
