<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Grouping.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyGrid.Grouping" Title="DataGrid - Grouping Example" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="article col-md-9">
        ...
        <p>
            This example demonstrates how to use grouping in the Soby Data Grid.
            <br />
        ...
        <p>
            Below functionality uses "GroupBy" method which takes two parameters. First one is the name of the field. Second one is a boolean value to state whether it should be sorted as ascending or descending. This method triggers the data population.
        <pre class="js">bookGrid.GroupBy("Genre", true); </pre>
        </p>
