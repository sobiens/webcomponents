<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Scrollable.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyGrid.Scrollable" Title="DataGrid - Paging Example" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div>
            <p>This example demonstrates how to use paging in the Soby Data Grid. <br />
        The DataGrid limits the number of records displayed on the pages. This feature improves the performance on both client side (number of records rendered) and server side (if paging enabled api is in used on the datagrid).
                "RowLimit" property takes states the number of records will be rendered on the each and number of record will be retrieved from server api.
        <pre class="js">bookService.SetRowLimit(5); </pre>
                The default rowlimit property value is 100. To disable paging and display all the values use the following code
        <pre class="js">bookService.SetRowLimit(0);</pre>
    </p>
...
&lt;/body&gt;
&lt;/html&gt;</div>
                <div class="csscode">.soby_grid .gridbody { max-height: 150px; }</div>
