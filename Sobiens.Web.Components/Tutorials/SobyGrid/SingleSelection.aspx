<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="SingleSelection.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyGrid.SingleSelection" Title="DataGrid - Selection Example" %>
...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    ...
    <hgroup class="title">
        <h1><%: Title %></h1>
        <br />
        <h2>Single Selection Example</h2>
    </hgroup>
        </div>
    </section>
</asp:Content>
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <script language="javascript">
        ...
        <p>This example demonstrates how to use selection in the Soby Data Grid. <br>
        "SelectRowByIndex" method takes one parameter. The parameter accepts the value as index of the row. This method selects the row by given row index.
        </p>
        <pre class="js">bookGrid.SelectRowByIndex(1); </pre>
        <p>
        "AllowMultipleSelections" property is used to state whether user can select multiple or single row. "false" will allow user to select single row.
        </p>
        <pre class="js">bookGrid.AllowMultipleSelections = false; </pre>
...
&lt;/html&gt;</div>
    ...
    bookGrid.AllowMultipleSelections = false;
    bookGrid.OnGridPopulated = function () {
        bookGrid.SelectRowByIndex(1);
    };
