<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="CustomFiltering.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyGrid.CustomFiltering" Title="Grid" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>Filter by 
        ...
        <div class="article" style="float: left;width: 74%;">
            ...
            <script src="/Scripts/Tutorials/WebAPI/Grid/customfiltering.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/Grid/customfiltering.js" style="display:none;background-color:ivory">
