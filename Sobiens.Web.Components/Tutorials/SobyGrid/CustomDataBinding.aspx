<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="CustomDataBinding.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyGrid.CustomDataBinding" Title="Grid" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="article col-md-9">
            ...
            <script src="/Scripts/Tutorials/WebAPI/Grid/customdatabinding.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/Grid/customdatabinding.js" style="display:none;background-color:ivory">
