...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    ...
    <hgroup class="title">
        <h1><%: Title %></h1>
        <br />
        <h2>Item Selection as TreeView</h2>
    </hgroup>
        </div>
    </section>
</asp:Content>
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>This example demonstrates how to use Soby Item Selection as treeview selection. <br />
        ...
        <div class="article" style="float: left;width: 74%;">
            ...
            <script src="/Scripts/Tutorials/WebAPI/ItemSelection/treeviewselection.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/ItemSelection/treeviewselection.js" style="display:none;background-color:ivory">
...
<span class="tag_start">&lt;script</span> <span class="attr_name">src</span>=<span class="attr_value">"/media/js/soby.ui.components.treeview.js"</span> <span class="tag_start">&gt;&lt;/script&gt;</span>
