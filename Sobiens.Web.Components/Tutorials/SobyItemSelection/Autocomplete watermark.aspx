<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Autocomplete watermark.aspx.cs" Inherits="Sobiens.Web.Components.Tutorials.SobyItemSelection.Autocomplete_watermark" Title="Item Selection Single" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>This example demonstrates how to use Soby Item Selection as single selection. <br />
        ...
        <div class="article" style="float: left;width: 74%;">
            ...
            <script src="/Scripts/Tutorials/WebAPI/ItemSelection/autocompletewatermark.js"></script>
        ...
        <pre id="ViewSourceDiv" class="viewsource html" codefile="/Scripts/Tutorials/WebAPI/ItemSelection/autocompletewatermark.js" style="display:none;background-color:ivory">
